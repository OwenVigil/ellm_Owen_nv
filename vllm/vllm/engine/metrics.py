...
class Metrics:
    ...
    def __init__(self, labelnames: List[str], max_model_len: int):
        ...
        self.info_ellm_config = Info(
            name='vllm:ellm_config',
            documentation='Static eLLM experiment configuration.')
        ...
        self.counter_generation_tokens = Counter(
            ...
            labelnames=labelnames)
        self.counter_ellm_recompute_tokens = Counter(
            name="vllm:ellm_recompute_tokens_total",
            documentation="Number of prefix tokens regenerated by eLLM.",
            labelnames=labelnames)
...
class Stats:
    ...
    num_ellm_recompute_tokens_iter: int
...
class StatLogger:
    ...
    def info(self, type: str, obj: SupportsMetricsInfo) -> None:
        ...
        elif type == "ellm_config":
            self.metrics.info_ellm_config.info(obj.metrics_info())
    ...
    def _log_prometheus(self, stats: Stats) -> None:
        ...
        self._log_counter(self.metrics.counter_ellm_recompute_tokens,
                          stats.num_ellm_recompute_tokens_iter)
